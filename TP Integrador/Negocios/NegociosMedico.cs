...
namespace Negocios
{
    public class NegociosMedico
    {
        ...
        public DataTable FiltrarMedicoLegajoNegocios(int Legajo) //Muestra y filtra un paciente con los campos seleccionados 
        {
            return datosM.FiltrarMedicoLegajoBajaDatos(Legajo);
        }
        public DataTable FiltrarMedicosPorLegajoNegocio(int legajo) //Muestra y filtra un paciente por DNI con todos los campos
        {
