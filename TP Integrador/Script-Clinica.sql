...
--DBCC CHECKIDENT ('Medicos', RESEED, 0); --Resetea a 0
...
INSERT INTO MedicoXDias (Legajo_med_mxd, IdDia_d_mxd, IdHorario_h_mxd)
SELECT 1, 1, 1 UNION 
SELECT 1, 2, 2 UNION 
SELECT 1, 3, 3 UNION 
SELECT 1, 4, 4 UNION 
...
INSERT INTO Turnos (IdPaciente_tu, IdMedico_tu, FechaTurno_tu, IdEstadoTurno_tu)
SELECT '1234567890', 1, '2024-11-10', 1 UNION   -- Juan Perez con medico 1
SELECT '2345678901', 2, '2024-11-10', 1 UNION   -- Maria Gomez con medico 2
SELECT '3456789012', 3, '2024-11-11', 1 UNION   -- Carlos Lopez con medico 3
SELECT '4567890123', 4, '2024-11-11', 1 UNION   -- Ana Martinez con medico 4
SELECT '5678901234', 5, '2024-11-12', 2 UNION   -- Jose Fernandez con medico 5
SELECT '6789012345', 6, '2024-11-12', 2 UNION   -- Laura Diaz con medico 6
SELECT '7890123456', 7, '2024-11-13', 1 UNION   -- Miguel Garcia con medico 7
SELECT '8901234567', 8, '2024-11-13', 1 UNION   -- Lucia Ruiz con medico 8
SELECT '9012345678', 1, '2024-11-14', 2 UNION   -- Diego Sanchez con medico 1
SELECT '0123456789', 2, '2024-11-14', 2 UNION   -- Marta Benitez con medico 2
SELECT '1234567890', 3, '2024-11-15', 3 UNION   -- Juan Perez con medico 3
SELECT '2345678901', 4, '2024-11-15', 3 UNION   -- Maria Gomez con medico 4
SELECT '3456789012', 5, '2024-11-16', 1 UNION   -- Carlos Lopez con medico 5
SELECT '4567890123', 6, '2024-11-16', 1 UNION   -- Ana Martinez con medico 6
SELECT '5678901234', 7, '2024-11-17', 2 UNION   -- Jose Fernandez con medico 7
SELECT '6789012345', 8, '2024-11-17', 2         -- Laura Diaz con medico 8
GO
