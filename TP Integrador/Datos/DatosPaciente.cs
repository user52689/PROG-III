...
namespace Datos
{
    public class DatosPaciente
    {
        ...
        //------------------------------------------------------------------------------------Obtener paciente
        public DataTable GetTablaPacientesDatos() //Todos los pacientes 
        {
            string consulta = "SELECT * " +
                              "FROM Pacientes";
            return ad.ObtenerTabla("Pacientes", consulta);
        }
        public DataTable FiltrarPacienteDNIDatos(string DNI) //Paciente filtrado para la baja de paciente
        {
            ...
            SqlCommand cmd = new SqlCommand(consulta);
            cmd.Parameters.AddWithValue("@DNI", DNI);
            return ad.ObtenerTablaConComando("Paciente", cmd);
        }
