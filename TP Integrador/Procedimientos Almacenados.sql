...
BEGIN
    BEGIN TRY
        ...
        INSERT INTO Medicos (Legajo_med, DNI_med, Nombre_med, Apellido_med, Genero_med, Nacionalidad_med, FechaNacimiento_med, Direccion_med, Localidad_med, Provincia_med, CorreoElectronico_med, Telefono_med, Especialidad_med)
        VALUES (@Legajo_med, @DNI_med, @Nombre_med, @Apellido_med, @Genero_med, @Nacionalidad_med, @FechaNacimiento_med, @Direccion_med, @Localidad_med, @Provincia_med, @CorreoElectronico_med, @Telefono_med, @Especialidad_med);
